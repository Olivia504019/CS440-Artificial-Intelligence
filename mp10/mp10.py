...
def main(args):
    ...
    for lr in np.arange(0.0001, 0.0012, 0.0002):
        for h1 in np.arange(40, 70, 20):
            for h2 in np.arange(20, h1 + 20, 20):
                print("learning rate:", lr, ", hidden size:", (h1, h2))
                L, predicted_labels, net = p.fit(train_set, train_labels, dev_set, args.epochs, hidden_size_1=h1, hidden_size_2=h2, learning_rate=lr)
                ...
                if accuracy > best_acc:
                    best_lr, best_h, best_acc = lr, (h1, h2), accuracy
    print("best learning rate:", best_lr, ", best hidden size:", best_h, ", accuracy:", best_acc)
